...
export function getInvoiceSample3CSS() {
    return `
        /* --- General Invoice Styling (8px Base) --- */
        .invoice-wrapper {
            max-width: 800px;
            margin: auto;
            padding: 25px;
            ...
            /* ✅ EXTREMELY COMPACT: 8px base font size */
            font-size: 8px;
            line-height: 12px;
        }
        ...
        .logo-area h2 { font-weight: bold; font-size: 14px; margin-top: 4px; }
        .invoice-info h1 { font-size: 24px; font-weight: bold; color: #3b82f6; }
        .invoice-info p { text-align: right; font-size: 9px; line-height: 1.4; }
        .invoice-info p span { color: #6b7280; }

        /* --- From/To Section --- */
        .invoice-parties { display: flex; justify-content: space-between; margin-bottom: 25px; border-top: 1px solid #eee; border-bottom: 1px solid #eee; padding: 10px 0; font-size: 9px; }
        .invoice-parties h3 { font-size: 8px; color: #6b7280; text-transform: uppercase; margin-bottom: 4px; }

        /* --- Main Body and Table --- */
        .invoice-body { display: block; margin-bottom: 15px; }
        .line-items-table { width: 100%; border-collapse: collapse; }
        .line-items-table th, .line-items-table td { padding: 6px; text-align: left; border-bottom: 1px solid #eee; font-size: 9px; }
        ...
        /* --- Summary Section --- */
        .invoice-summary-section { display: flex; justify-content: flex-end; margin-top: 15px; }
        .payment-sidebar { width: 240px; flex-shrink: 0; background: #f8fafc; padding: 15px; border-radius: 6px; }
        .payment-sidebar h4 { font-weight: bold; margin-bottom: 8px; border-bottom: 1px solid #e2e8f0; padding-bottom: 4px; font-size: 10px; }
        .payment-sidebar .summary-item { display: flex; justify-content: space-between; font-size: 9px; margin-bottom: 6px; }
        .payment-sidebar .grand-total { font-size: 11px; font-weight: bold; margin-top: 8px; }
        ...
        .status-badge { font-size: 8px; font-weight: bold; padding: 2px 6px; border-radius: 9999px; }
        ...
        .signature-section { margin-top: 40px; width: 180px; }
        .signature-line { border-top: 1px solid #333; margin-bottom: 4px; }
        .signatory-name { font-weight: bold; font-size: 10px; }
        .signatory-title { font-size: 9px; color: #6b7280; }
        .invoice-footer { margin-top: 25px; text-align: center; font-size: 8px; color: #9ca3b8; border-top: 1px solid #eee; padding-top: 10px; }
    `;
}
