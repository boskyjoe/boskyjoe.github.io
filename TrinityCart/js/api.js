...
import {
    ...
    DONATION_SOURCES,
    getDonationSourceByStore, EXPENSES_COLLECTION_PATH, EXPENSE_RECEIPTS_STORAGE_PATH, imageKitConfig,DRAFT_SALES_COLLECTION_PATH,LEADS_COLLECTION_PATH,LEADS_WORKLOG_SUBCOLLECTION,
    SIMPLE_CONSIGNMENT_COLLECTION_PATH
} from './config.js';
 ...
 */
export async function updateSaleInfo(saleId, newStore, newAddress, newCustomerName, user) {
    const db = firebase.firestore();
