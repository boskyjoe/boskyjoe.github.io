...
export const navConfig = [
    ...
    // 2. Pre-Sales Section
    { type: "heading", label: "Pre-Sales", roles: ["admin", "sales_staff", "team_lead"] },
    {
        type: "link",
        label: "Enquiries",
        indent: true, // Custom property for indentation
