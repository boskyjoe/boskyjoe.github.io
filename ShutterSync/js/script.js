...
<head>
    ...
    <style>
        ...
        /* Ensure grid headers can wrap text and allow horizontal scrolling */
        .gridjs-container {
            overflow-x: auto;
            ...
            overflow: hidden;
            /* Ensures rounded corners apply to the grid */
        }
...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow container mx-auto p-6">
        ...
        <section id="customers-section" class="hidden">
            ...
            <div id="customer-form-container" class="hidden bg-white p-6 rounded-lg shadow-md mb-6">
                ...
                <form id="customer-form" class="space-y-4">
                    ...
                    <div>
                        <label for="customer-additional-details"
                            class="block text-sm font-medium text-gray-700">Additional
                            Details</label>
                        <textarea id="customer-additional-details" rows="3"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></textarea>
                    </div>
                    <div>
        ...
        <section id="opportunities-section" class="hidden">
            ...
            <div id="opportunity-form-container" class="hidden bg-white p-6 rounded-lg shadow-md mb-6">
                ...
                <div id="opportunity-accordions-grid" class="grid grid-cols-1 md:grid-cols-2 gap-6">

                    <!-- Main Opportunity Details Accordion -->
                    <div id="main-opportunity-details-accordion" class="accordion-item bg-white rounded-lg shadow-md">
                        <!-- REMOVED md:col-span-full HERE -->
                        <div
                        ...
                        <!-- CRITICAL HTML FIX 1: Add ID to accordion content -->
                        <div id="main-details-content" class="accordion-content hidden pt-4">
                            <form id="opportunity-form" class="space-y-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                <input type="hidden" id="opportunity-id">

                                <div>
                                    <label for="opportunity-name"
                                        class="block text-sm font-medium text-gray-700">Opportunity Name <span
                                ...
                                <div>
                                    <label for="opportunity-customer"
                                        class="block text-sm font-medium text-gray-700">Customer <span
                                            class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="opportunity-currency"
                                        class="block text-sm font-medium text-gray-700">Currency <span
                                            class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="opportunity-expected-start-date"
                                        class="block text-sm font-medium text-gray-700">Expected Start Date</label>
                                    <input type="date" id="opportunity-expected-start-date" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                                    focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="opportunity-expected-close-date"
                                        class="block text-sm font-medium text-gray-700">Expected Close Date</label>
                                    <input type="date" id="opportunity-expected-close-date" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                                    focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="opportunity-sales-stage"
                                        class="block text-sm font-medium text-gray-700">Sales Stage <span
                                            class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="opportunity-value"
                                        class="block text-sm font-medium text-gray-700">Opportunity Value <span
                                            class="text-red-500">*</span></label>
                                    <input type="number" id="opportunity-value" step="0.01" min="0" required
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>

                                <!-- New Fields for Opportunity Discount, Adjustment Amt, and Net -->
                                <div>
                                    <label for="opportunity-discount"
                                        class="block text-sm font-medium text-gray-700">Opportunity Discount%</label>
                                    <input type="number" step="0.01" id="opportunity-discount" name="discount" value="0"
                                        min="0" max="100"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="opportunity-adjustment-amt"
                                        class="block text-sm font-medium text-gray-700">Adjustment Amt</label>
                                    <input type="number" step="0.01" id="opportunity-adjustment-amt"
                                        name="adjustmentAmt" value="0" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                                    focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="opportunity-net-span"
                                        class="block text-sm font-medium text-gray-700">Opportunity Net</label>
                                    <span id="opportunity-net-span" class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-gray-100 rounded-md
                                        shadow-sm sm:text-sm">0.00</span>
                                </div>
                                <!-- End New Fields -->

                                <div class="col-span-full">
                                    <label for="opportunity-services-interested"
                                        class="block text-sm font-medium text-gray-700">Services Interested <span
                                            class="text-red-500">*</span></label>
                                    <select id="opportunity-services-interested" name="servicesInterested" multiple
                                        required
                                ...
                                <!-- Save and Cancel buttons, and form message, inside this form -->
                                <p id="opportunity-form-message" class="text-red-500 text-sm mt-2 hidden col-span-full">
                                </p>
                    ...
                    <!-- Work Logs Accordion (Right Column, hidden by default) -->
                    <div id="opportunity-work-logs-section" class="accordion-item bg-white rounded-lg shadow-md hidden">
                        <div
                            class="accordion-header flex justify-between items-center cursor-pointer p-3 rounded-t-lg bg-gray-100 hover:bg-gray-200 transition duration-200">
                            <h3 class="text-lg font-semibold text-gray-800">Work Logs</h3>
                            <span class="accordion-icon transform transition-transform duration-200">&#9660;</span>
                        </div>
                        <!-- CRITICAL HTML FIX 7: Add ID to accordion content -->
                        <div id="opportunity-work-logs-content" class="accordion-content hidden pt-4">
                            <div id="work-logs-list-wrapper" class="mb-4">
                                <!-- Renamed for clarity, not strictly necessary -->
                                <p id="no-work-logs-message" class="text-center text-gray-500 hidden">No work logs found
                                    for this opportunity.</p>
                                <ul id="opportunity-work-logs-container" class="space-y-2"></ul>
                                <!-- CRITICAL HTML FIX 8: Correct ID for UL -->
                            </div>

                            <button id="add-work-log-btn" type="button" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition
                                duration-300 mb-4">Add
                            ...
                            <div id="work-log-form-container" class="hidden bg-gray-50 p-4 rounded-lg shadow-inner">
                                ...
                                <form id="work-log-form" class="space-y-4">
                                    ...
                                    <div>
                                        <label for="work-log-date" class="block text-sm font-medium text-gray-700">Date
                                    ...
                                    <div>
                                        <label for="work-log-type" class="block text-sm font-medium text-gray-700">Type
                                            <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="work-log-details"
                                            class="block text-sm font-medium text-gray-700">Details <span
                                                class="text-red-500">*</span></label>
                ...
                </div> <!-- END #opportunity-accordions-grid -->
            </div>
        ...
        <section id="quotes-section" class="hidden">
            <h1 class="text-3xl font-bold text-gray-800 header">Quotes</h1>
            <button id="add-quote-btn"
                class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300 mb-6">Add
                New Quote</button>

            <!-- Filter display for quotes -->
            <div id="quotes-filter-display"
                class="bg-blue-100 border border-blue-200 text-blue-800 px-4 py-2 rounded-md mb-4 flex items-center justify-between hidden">
                <span>Showing quotes for opportunity: <span id="quotes-filter-opportunity-name"
                        class="font-semibold"></span></span>
                <button id="clear-quotes-filter-btn"
                    class="ml-4 px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition duration-300 text-sm">Clear
                    Filter</button>
            </div>

            <div id="quote-form-container" class="form-container hidden">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">Quote Details</h2>

                <!-- NEW: Grid container for dynamic side-by-side or full-width accordions for Quotes -->
                <div id="quote-accordions-grid" class="grid grid-cols-1 md:grid-cols-2 gap-6">

                    <!-- Main Quote Details Accordion (Left Column / Full Span dynamically) -->
                    <!-- This accordion's content is the ONLY thing inside #quote-form -->
                    <form id="quote-form"> <!-- #quote-form starts here -->
                        <div id="main-quote-details-accordion"
                            class="accordion-item bg-white rounded-lg shadow-md">
                            <div
                                class="accordion-header flex justify-between items-center cursor-pointer p-3 rounded-t-lg bg-gray-100 hover:bg-gray-200 transition duration-200">
                                <h3 class="text-lg font-semibold text-gray-800">Main Details</h3>
                                <span class="accordion-icon transform transition-transform duration-200">&#9660;</span>
                            </div>
                            <div id="main-quote-details-content"
                                class="accordion-content hidden pt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                <input type="hidden" id="quote-id">
                                <div>
                                    <label for="quote-event-name" class="block text-sm font-medium text-gray-700">Event
                                        Name
                                        <span class="text-red-500">*</span></label>
                                    <input type="text" id="quote-event-name" name="eventName" required
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="quote-name" class="block text-sm font-medium text-gray-700">Quote Name
                                        <span class="text-red-500">*</span></label>
                                    <input type="text" id="quote-name" name="quoteName" required
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="quote-opportunity"
                                        class="block text-sm font-medium text-gray-700">Opportunity <span
                                            class="text-red-500">*</span></label>
                                    <select id="quote-opportunity" name="opportunityId" required
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <!-- Options populated by JavaScript -->
                                    </select>
                                </div>
                                <div>
                                    <label for="quote-event-date" class="block text-sm font-medium text-gray-700">Event
                                        Date</label>
                                    <input type="date" id="quote-event-date" name="eventDate"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="quote-customer-contact-name"
                                        class="block text-sm font-medium text-gray-700">Customer Contact Name</label>
                                    <input type="text" id="quote-customer-contact-name" name="customerContactName"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-gray-50 rounded-md shadow-sm sm:text-sm"
                                        readonly>
                                </div>
                                <div>
                                    <label for="quote-phone" class="block text-sm font-medium text-gray-700">Customer
                                        Phone</label>
                                ...
                                <div>
                                    <label for="quote-email" class="block text-sm font-medium text-gray-700">Customer
                                        Email</label>
                                ...
                                <div>
                                    <label for="quote-customer-address"
                                        class="block text-sm font-medium text-gray-700">Customer Address</label>
                                    <input type="text" id="quote-customer-address" name="customerAddress"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-gray-50 rounded-md shadow-sm sm:text-sm"
                                        readonly>
                                </div>
                                <div>
                                    <label for="quote-amount" class="block text-sm font-medium text-gray-700">Quote
                                        Amount</label>
                                    <input type="number" step="0.01" id="quote-amount" name="quoteAmount"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                        readonly>
                                </div>
                                <div>
                                    <label for="quote-status" class="block text-sm font-medium text-gray-700">Status
                                        <span class="text-red-500">*</span></label>
                                    <select id="quote-status" name="status" required
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <!-- Options populated by JavaScript -->
                                    </select>
                                </div>
                                <div class="col-span-full">
                                    <label for="quote-additional-details"
                                        class="block text-sm font-medium text-gray-700">Additional Details</label>
                                    <textarea id="quote-additional-details" name="additionalDetails" rows="3"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></textarea>
                                </div>

                                <!-- MOVED: Save and Cancel buttons, and form message, inside this accordion's content -->
                                <p id="quote-form-message" class="text-red-600 text-sm mt-2 hidden col-span-full"></p>
                                <div class="flex justify-end space-x-3 mt-6 col-span-full">
                    ...
                    </form> <!-- #quote-form ends here -->

                    <!-- NEW: Quote Lines Accordion (Right Column, hidden by default) -->
                    <!-- This is now a sibling to #quote-form within #quote-accordions-grid -->
                    <div id="quote-lines-section-container" class="accordion-item bg-white rounded-lg shadow-md hidden">
                        <div
                            class="accordion-header flex justify-between items-center cursor-pointer p-3 rounded-t-lg bg-gray-100 hover:bg-gray-200 transition duration-200">
                            <h3 class="text-lg font-semibold text-gray-800">Quote Lines</h3>
                            <span class="accordion-icon transform transition-transform duration-200">&#9660;</span>
                        </div>
                        <div id="quote-lines-content" class="accordion-content hidden pt-4">
                            <button id="add-quote-line-entry-btn"
                                class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition duration-300 mb-4">Add
                                New Quote Line</button>

                            <div id="quote-line-form-container"
                                class="form-container hidden p-4 border border-gray-200 rounded-md mb-4">
                                <h4 class="text-md font-semibold text-gray-800 mb-3">Add/Edit Quote Line</h4>
                                <!-- #quote-line-form is correctly placed here, as a separate form -->
                                <form id="quote-line-form">
                                    <input type="hidden" id="quote-line-id">
                                    <input type="hidden" id="quote-line-parent-quote-id">
                                    <!-- To link to parent quote -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label for="quote-line-services"
                                                class="block text-sm font-medium text-gray-700">Services <span
                                                    class="text-red-500">*</span></label>
                                            <input type="text" id="quote-line-services" name="services" required
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div class="col-span-full">
                                            <label for="quote-line-description"
                                                class="block text-sm font-medium text-gray-700">Service
                                                Description</label>
                                            <textarea id="quote-line-description" name="serviceDescription" rows="2"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></textarea>
                                        </div>
                                        <div>
                                            <label for="quote-line-start-date"
                                                class="block text-sm font-medium text-gray-700">Service Start
                                                Date</label>
                                            <input type="date" id="quote-line-start-date" name="serviceStartDate"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label for="quote-line-end-date"
                                                class="block text-sm font-medium text-gray-700">Service End
                                                Date</label>
                                            <input type="date" id="quote-line-end-date" name="serviceEndDate"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label for="quote-line-unit-price"
                                                class="block text-sm font-medium text-gray-700">Unit Price <span
                                                    class="text-red-500">*</span></label>
                                            <input type="number" step="0.01" id="quote-line-unit-price" name="unitPrice"
                                                required value="0"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label for="quote-line-quantity"
                                                class="block text-sm font-medium text-gray-700">Quantity <span
                                                    class="text-red-500">*</span></label>
                                            <input type="number" step="1" id="quote-line-quantity" name="quantity"
                                                required value="1"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label for="quote-line-discount"
                                                class="block text-sm font-medium text-gray-700">Discount (%)</label>
                                            <input type="number" step="0.01" min="0" max="100" id="quote-line-discount"
                                                name="discount" value="0"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div>
                                            <label for="quote-line-adjustment-amount"
                                                class="block text-sm font-medium text-gray-700">Adjustment
                                                Amount</label>
                                            <input type="number" step="0.01" id="quote-line-adjustment-amount"
                                                name="adjustmentAmount" value="0"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        </div>
                                        <div class="col-span-full">
                                            <label for="quote-line-final-net"
                                                class="block text-sm font-medium text-gray-700">Final Net</label>
                                            <span id="quote-line-final-net"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-gray-100 rounded-md shadow-sm sm:text-sm">0.00</span>
                                        </div>
                                    </div>
                                    <p id="quote-line-form-message" class="text-red-600 text-sm mt-2 hidden"></p>
                                    <div class="flex justify-end space-x-3 mt-4">
                                        <button type="button" id="cancel-quote-line-btn"
                                            class="px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 transition duration-300">Cancel</button>
                                        <button type="submit"
                                            class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300">Save
                                            Quote Line</button>
                            ...
                            <ul id="quote-lines-list" class="space-y-3 mt-4">
                                <!-- Quote line entries will be loaded here by JavaScript -->
                            </ul>
                            <p id="no-quote-lines-message" class="text-gray-500 text-center mt-4 hidden">No quote
                                lines for this quote yet.</p>
                        </div>
                    </div>

                </div> <!-- END #quote-accordions-grid -->
            </div> <!-- END #quote-form-container -->

            <div class="mt-6">
                <input type="text" id="quote-search" placeholder="Search quotes..."
                    class="mb-4 px-4 py-2 border border-gray-300 rounded-md w-full md:w-1/3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                <div id="quotes-grid-container" class="gridjs-container"></div>
                <p id="no-quotes-message" class="text-gray-500 text-center mt-4 hidden">No quotes found. Add a new quote
                    to get started!</p>
            </div>
        </section>
    ...
    <!-- Message Box (Modal) -->
    <div id="message-box" class="fixed inset-0 bg-gray-700 bg-opacity-60 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md md:max-w-lg text-center overflow-hidden">

            <!-- Title Bar -->
            <div class="bg-blue-600 text-white p-4 shadow-md text-lg font-bold tracking-wide">
                Notification
            </div>

            <!-- Content -->
            <div class="p-6">
                <p id="message-content" class="text-lg font-semibold text-gray-800 mb-4">Your action was successful!</p>
                <div class="flex justify-center space-x-4">
                    <button id="message-confirm-btn"
                        class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300 hidden focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-md">
                        ✔️ Confirm
                    </button>
                    <button id="message-cancel-btn"
                        class="px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 transition duration-300 focus:outline-none focus:ring-2 focus:ring-gray-500">
                        ✖️ OK
                    </button>
                </div>
            </div>
